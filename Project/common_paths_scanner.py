...
class CommonPathsScanner:
    ...
    def generate_paths_report(self, output_file: str = "data/common_paths_scan.json"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", default="data/common_paths_scan.json", help="Output file")
    ...
    print(f"Scan completed. Discovered {summary['total_discovered']} paths")
